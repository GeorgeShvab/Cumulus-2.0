...
import { PopupProps, Position } from "@/components/Popup/types";
    ...
    if (anchor && container.current) {
      ...
      if (pos === "bottom") {
        contentPosition.left =
          acnhorPosition.left +
          (posCorrection?.left || 0) -
          (containerPosition.width / 2 - acnhorPosition.width / 2);
        ...
        contentPosition.top =
          acnhorPosition.top +
          (posCorrection?.top || 0) -
          (containerPosition.height / 2 - acnhorPosition.height / 2);
      } else if (pos === "right") {
        contentPosition.left =
          acnhorPosition.right + (posCorrection?.left || 0);
        contentPosition.top =
          acnhorPosition.top +
          (posCorrection?.top || 0) -
          (containerPosition.height / 2 - acnhorPosition.height / 2);
      ...
      if (window.innerWidth) {
        ...
        if (
          contentPosition.left + containerPosition.width >
        ...
        if (contentPosition.top < 5) {
          contentPosition.left =
            ...
            (containerPosition.width / 2 - acnhorPosition.width / 2);
          contentPosition.top =
            acnhorPosition.bottom + (posCorrection?.top || 0);
        }

        if (
          contentPosition.top + containerPosition.height >
