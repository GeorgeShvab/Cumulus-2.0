...
const Settings: FC<{ onClose: () => void; show: boolean }> = ({
  onClose,
  show,
}) => {
    ...
    <Modal onClose={onClose} show={show}>
      <div className="px-2 lg:px-0 w-screen sm:w-[30rem] lg:w-fit">
        <div className="bg-white p-5 lg:p-10 rounded-lg">
          <h2 className="text-center text-xl font-semibold mb-8 lg:mb-12">
            Налаштування
          </h2>
          <div>
            <div className="flex gap-8 lg:gap-16 justify-between items-center mb-5">
              ...
              <div className="flex gap-1">
                <Button
                  onClick={() =>
                    setSpecificSettings("temperatureUnit", "celsius")
                  }
                ...
                <Button
                  onClick={() =>
                    setSpecificSettings("temperatureUnit", "fahrenheit")
                  }
            ...
            <div className="flex gap-8 lg:gap-16 justify-between items-center mb-5">
              ...
              <div className="flex gap-1">
                <Button
                  onClick={() => setSpecificSettings("speedUnit", "kmh")}
                  choosed={settings.speedUnit === "kmh"}
                >
                  км/год
                </Button>
                <Button
                  onClick={() => setSpecificSettings("speedUnit", "mph")}
                  choosed={settings.speedUnit === "mph"}
                >
                  миль/год
                </Button>
                <Button
                  onClick={() => setSpecificSettings("speedUnit", "ms")}
                  choosed={settings.speedUnit === "ms"}
                >
                  м/с
                </Button>
              </div>
